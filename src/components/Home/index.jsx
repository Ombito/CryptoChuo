...
const Home = () => {
    const faqData = [
        { question: 'So your aim is educating the world on Blockchain technology?', answer: "It's ok you can say it. Decentralization is important but what underpins it? That's the complication. Our strategy is to create grassroot level of mass awareness on cryptocurrencies and DeFi systems." },
